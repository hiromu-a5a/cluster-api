...
func (r *rollout) ObjectViewer(proxy cluster.Proxy, ref corev1.ObjectReference, revision int64) error {
	...
	case MachineDeployment:
		...
		if err := viewMachineDeployment(proxy, deployment, revision); err != nil {
			return err
		}
	default:
...
func viewMachineDeployment(proxy cluster.Proxy, d *clusterv1.MachineDeployment, revision int64) error {
	log := logf.Log
